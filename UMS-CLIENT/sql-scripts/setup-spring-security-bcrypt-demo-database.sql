...
INSERT INTO `users` 
VALUES 
('ashique','{bcrypt}$2a$04$eFytJDGtjbThXa80FyOOBuFdK2IwjyWefYkMpiBEFlpBwDH.5PM0K',1),
...
VALUES 
('ashique','ROLE_EMPLOYEE'),
('ashique','ROLE_ADMIN'),
('john','ROLE_EMPLOYEE'),
('mary','ROLE_EMPLOYEE'),
('mary','ROLE_INSTRUCTOR_ADVISER'),
('susan','ROLE_EMPLOYEE'),
('susan','ROLE_STUDENT_ADVISER');